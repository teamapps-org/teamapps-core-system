...
public class ClusterPerspective extends AbstractManagedApplicationPerspective {

	public ClusterPerspective(ApplicationInstanceData applicationInstanceData, MutableValue<String> perspectiveInfoBadgeValue) {
		super(applicationInstanceData, perspectiveInfoBadgeValue);
		createUi();
	}

	private void createUi() {
		ClusterNodesPerspectiveBuilder clusterNodesPerspectiveBuilder = new ClusterNodesPerspectiveBuilder();
		PerspectiveMenuPanel menuPanel = PerspectiveMenuPanel.createMenuPanel(getApplicationInstanceData(),
				clusterNodesPerspectiveBuilder,
				new ClusterServicesPerspectiveBuilder(),
				new ClusterReplicatedStatesPerspectiveBuilder()
		);
		setPerspectiveMenuPanel(menuPanel.getComponent(), menuPanel.getButtonMenu());
		onPerspectiveInitialized.addListener(() -> menuPanel.openPerspective(clusterNodesPerspectiveBuilder));
	}
